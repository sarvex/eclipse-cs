...
public final class ConfigurationReader {
     ...
     */
    public static List<Module> read(final InputStream in)
        throws CheckstylePluginException {
     ...
     *             error while reading the configuration
     */
    public static AdditionalConfigData getAdditionalConfigData(
        final InputStream in) throws CheckstylePluginException {
